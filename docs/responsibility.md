...
Conversations around ethical accountability for scientific discoveries and their real-world applications have a long history, extending beyond the scientific community itself. Each research field faces distinct risks and benefits, and EEG is no exception. In particular, EEG has been explored for sensitive or potentially sensitive uses, such as detecting “concealed information” [(Farwell, 2012; Rosenfeld, 2005; Wolpe et al., 2005\)](https://www.zotero.org/google-docs/?36ZISQ), enabling implicit interaction outside the participant’s awareness [(Fairclough, 2017; Krol et al., 2020; Zander et al., 2016\)](https://www.zotero.org/google-docs/?ftpej6), and launching so-called “side-channel attacks” that decode private data like PIN codes [(Lange et al., 2018\)](https://www.zotero.org/google-docs/?aEm7p0). Together, these applications demonstrate the capacity of EEG to decode—and possibly influence—a person’s brain activity, heightening concerns about individual privacy [(Mecacci & Haselager, 2019\)](https://www.zotero.org/google-docs/?0C7kgV), mental integrity [(Ienca & Andorno, 2017\)](https://www.zotero.org/google-docs/?Wj1W63), and broader social equity [(Hyman, 2011\)](https://www.zotero.org/google-docs/?Va2t2k).

Researchers must carefully evaluate their work’s potential societal impacts, including how future developments may build on today’s findings. Although many EEG studies cite adherence to the Declaration of Helsinki, that document largely focuses on medical research, leaving gaps for more general EEG practices. Current legal discussions [(Muhl, 2024; Yuste, 2023\)](https://www.zotero.org/google-docs/?Qhs4VP) (e.g., Yuste, 2021; Muhl, 2024\) and best-practice recommendations [(Niso, Krol, et al., 2022c)](https://www.zotero.org/google-docs/?anUU9v) underscore the importance of addressing EEG-specific ethical considerations. Meanwhile, the increasing integration of ML/AI in EEG (e.g., automated signal classification, neural decoding) amplifies risks of inaccurate interpretations, overgeneralizations, and bias [(Birhane et al., 2024; Bolte & van Wynsberghe, 2024\)](https://www.zotero.org/google-docs/?ErCtwM). Beyond the Declaration of Helsinki, therefore, researchers and developers of EEG-based neurotechnology should look both at more generic frameworks concerning the use of personal data, automated decision-making, and AI, and at more specific guidelines concerning aspects directly related to neurotechnology, like [neurorights](https://neurorightsfoundation.org/). The former can guide the researcher, for example, in specifying verifiable quality criteria ahead of time and ensuring proper oversight, whereas the latter can aid in the evaluation of specific solutions, among other things.

A variety of organisations offer further guidance, both generic and specific. [UNESCO's reports on neurotechnology ethics](https://www.unesco.org/en/ethics-neurotech)  and the [OECD’s recommendations on responsible innovation in neurotechnology](https://legalinstruments.oecd.org/en/instruments/oecd-legal-0457) provide foundational strategies to safeguard privacy and autonomy, including in areas such as brain fingerprinting or generative AI [(Knoechel et al., 2024\)](https://www.zotero.org/google-docs/?sCjBdm). The [NeuroRights Foundation](https://neurorightsfoundation.org/) likewise advocates treating neural data as highly sensitive and recommends technical protections like encryption and differential privacy to avert misuse [(Yuste, 2023\)](https://www.zotero.org/google-docs/?w8dZGR). Taken together, these measures illustrate the growing consensus that EEG researchers must proactively address both the near-term ethical challenges and the longer-term implications of their work.
...
/// html | ul.tasklist
  ...
  /// html | li
    ...
    adhering to the CARE framework (Collective Benefit, Authority to Control, Responsibility, Ethics) [(Carroll et al., 2020b)](https://www.zotero.org/google-docs/?Zf8Ri4), integrating these values in all relevant processes and collaborations.  
  ///
  /// html | li
...
However, there can also be hype dynamics, and possibly cruel optimism [(Berlant, 2011\)](https://www.zotero.org/google-docs/?lDczJL), as our fascination with advanced, cutting-edge instrumentation can make projects that feature such tools seem inherently more compelling and worthwhile [(Nielsen & Andersen, 2022\)](https://www.zotero.org/google-docs/?broken=a5TWSS). Similar to the current fascination of the general public with neuroscientific explanations (Weisberg, 2018\) and brain imaging (McCabe, 2018), we should also see the risks of such biases, though \- hypes fade, and only time will tell how sustainable a progress was made.
...
Further, the production and disposal of scientific equipment contribute significantly to pollution and waste. Encouraging **equipment pooling, and sharing**, or applying the 3Rs approach [(“Reduce, Reuse, Recycle” Marques & Fritzen Gomes, 2020\)](https://www.zotero.org/google-docs/?SQPiR3) in the lab can help reduce the demand for new devices and extend the lifespan of existing ones. By reducing resource usage and waste production, we not only lessen our environmental impact but also encourage a more collaborative and cost-effective research environment.

Likewise, our field generates vast volumes of data, and we bear a responsibility to make sure they are fully utilized. Meta-analyses—where multiple teams aggregate already-collected datasets—also decrease resource usage, strengthen collaboration, and foster more reliable findings ([Koile & Cristia, 2021](https://direct.mit.edu/opmi/article/doi/10.1162/opmi_a_00048/107568/Toward-Cumulative-Cognitive-Science-A-Comparison)). To facilitate sharing and reuse, it is essential to standardize data acquisition and analysis and to manage data according to the FAIR principles [(Wilkinson et al., 2016c)](https://www.zotero.org/google-docs/?Jt9i2G), ensuring that it remains Findable, Accessible, Interoperable, and Reusable (See also Section 1.2).
